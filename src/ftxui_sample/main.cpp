...
// configuration step. It creates a namespace called `exploration`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", exploration::cmake::project_name, exploration::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", exploration::cmake::project_version);
      return EXIT_SUCCESS;
    }
